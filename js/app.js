...
const renderPokemonData = data => {
    ...
    pokeImg.setAttribute('src', sprites);
...
const renderPokemonTypes = types => {
    pokeTypes.innerHTML = ''
    types.forEach(type => {
        const typesTexElement = document.createElement('div');
        typesTexElement.style.color = typeColors[type.type.name];
        typesTexElement.textContent = type.type.name;
        pokeTypes.appendChild(typesTexElement);
    });
}
